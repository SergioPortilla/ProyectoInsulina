...
const FormNewOrder: FC<FormNewOrderData> = (props) => {
  ...
  return (
    <BoxPermissions className="InfoNewOrder">
              ...
              <>
                ...
                <InfoInsulines>
                  ...
                  <Separaciondos>
                    ...
                    <img src="../../../assets/images/icons/inyection.svg" alt="Inyection purple"></img>
      ...
      <ImgToDoCreationPage className="inyecciones" src="../../../assets/images/ilustrations/insuline-group.svg" alt="insuline-group" />
      <ImgBack src="../../../assets/images/ilustrations/background-shape-3.svg" alt="ilustration" />
    </BoxPermissions>
  );
};
