  ...
  return (
    <div>
      ...
      <InputForm
        ...
        onChange={(event) => props.setOrderUpdated({ ...props.orderUpdated, state: event.target.value as ActiveStates })}
        placeholder="State"
        name="state"
      ></InputForm>
      ...
      <InputForm
        type="date"
        value={props.orderUpdated.date_collected}
        onChange={(event) =>
          props.setOrderUpdated({
            ...props.orderUpdated,
            date_collected: event.target.value
          })
        }
